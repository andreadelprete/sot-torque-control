  ...
  namespace sot {
	...
	:public::dynamicgraph::Entity
      ...
      public: 
        ...
        DECLARE_SIGNAL_OUT(freeflyer_aa,              Eigen::Vector6d);  /// freeflyer position with angle axis format
        DECLARE_SIGNAL_OUT(base6dFromFoot_encoders,   dynamicgraph::Vector);  /// base6d_encoders with base6d in RPY
